...
**NGINX 1.13.9**, выпущенный 20 февраля 2018 года, включает поддержку HTTP/2-проталкивания на сервер. 
Чтобы отсылать ресурсы вместе с загрузкой страницы, используй http2_push директиву следующим образом:
...
💡 [Нажми сюда](https://forms.yandex.ru/cloud/6470530d73cee7130fc733b3/), **чтобы поделиться с нами обратной связью на этот проект**. Это анонимно и поможет команде Продукта сделать твоё обучение лучше.
